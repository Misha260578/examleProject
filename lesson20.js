...
function rander(){
    ...
    dataBase.userPriceDb.forEach((e, i) => {
     if (e) {
        ...
        titleContainer.append(divTitle)
...
function deleteUser(index){
    dataBase.userNameDb.splice(index, 1)
    dataBase.userPriceDb.splice(index, 1)
    console.log(dataBase.userNameDb, dataBase.userPriceDb)
    rander()
}
